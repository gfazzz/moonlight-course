 ...
 *   season-4/lib/ml_hash.c    — ключи записей из имён      (s04e03)
 *   season-6/lib/ml_crc.c     — целостность входных кадров (s06e05)
 *   season-9/lib/ml_btree.c   — индекс B-дерева            (s09e04)
 *   season-9/lib/ml_kalman.c  — оценка при шуме            (s09e07)
 *
