...
1. ✅ **Защита от багов** — случайно не перезапишешь важное значение
2. ✅ **Читаемость кода** — сразу видно, что не меняется
3. ✅ **Оптимизация** — компилятор может поместить в readonly-память
4. ✅ **Семантика** — явно показываешь намерение
