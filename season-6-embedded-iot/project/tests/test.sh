#!/bin/bash
# OPERATION MOONLIGHT — SEASON PROJECT iot_controller: автотест
...
"$PROJ/iot_controller" > "$OUT" 2>&1; rc=$?
...
rm -f "$OUT"
echo
echo "PASS: iot_controller собран из модулей нескольких сезонов и работает."
exit 0
