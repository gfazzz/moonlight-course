...
Каждая серия: один концепт, одна задача, ~35–55 минут, по шаблону v2.0 (сцена → теория → проверки от LUNA → задача → разбор ошибок → клиффхенгер). Теория «вглубь» и книги — в `theory.md` каждой серии.
