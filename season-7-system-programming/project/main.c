 ...
 *   season-1/lib/ml_crypto.c — XOR-шифр для скрытия полезной нагрузки (s01e06)
 *   season-6/lib/ml_crc.c    — целостность передаваемых кадров        (s06e05)
 *   season-7/lib/ml_proc.c   — запуск программ через fork+exec        (s07e02)
 *
