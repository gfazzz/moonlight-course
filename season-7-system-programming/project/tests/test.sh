#!/bin/bash
# OPERATION MOONLIGHT — SEASON PROJECT stealth_agent: автотест
...
rm -f "$OUT"
echo
echo "PASS: stealth_agent собран из модулей нескольких сезонов и работает."
exit 0
