...
- Динамическая память
- Работа с массивами
- **Проект**: Восстановление повреждённых данных из памяти

### Season 3: Networks (Сети)
*"Всё связано. Нужно лишь найти нить"*
- Сетевые протоколы (TCP/IP, UDP)
- Сокеты и клиент-серверная архитектура
- Packet sniffing и анализ трафика
- **Проект**: Перехват и анализ зашифрованных коммуникаций
...
- [ ] Season 2: Memory & Pointers (скоро)
- [ ] Season 3: Networks
