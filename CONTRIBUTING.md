...
Курс планируется на **42 эпизода** (10 сезонов). **Готово:** Season 1-4 @ 80%

**Текущий статус (v0.3.0):**
- 🟢 Season 1-4: 80% готовы (16 эпизодов, сюжет + теория + задачи)
- 🟡 Season 5-10: 20% готовы (26 эпизодов, базовая структура)
