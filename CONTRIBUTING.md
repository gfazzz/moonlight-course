...
Курс планируется на 32+ эпизода. **Готово:** 20 эпизодов (62.5%)

**Текущий статус:**
- ✅ Season 1-3: полностью готовы (12 эпизодов)
- ⏳ Season 4: частично готов (3.5/4 эпизода)
- ✅ Season 5: полностью готов (4 эпизода) 💰
- 🆕 Season 6-8: требуются контрибьюторы!
