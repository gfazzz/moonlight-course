 ...
 * Ячейка экрана = один СИМВОЛ, а не один байт: она хранит последовательность
 * байт целиком, поэтому подписи не обязаны быть ASCII. Курсор двигается на
 * ШИРИНУ символа; символ шириной два знакоместа занимает две ячейки, вторая
 * пустая. Разбор UTF-8 и таблица ширин — как в s05e08.
 */
#include <stdio.h>
#include <string.h>
