...
│
├── 📁 season-4-crypto-and-algorithms/  # Криптография
│   ├── 📄 README.md
│   ├── 📁 episode-13-key-hunt/
│   ├── 📁 episode-14-classic-ciphers/
│   ├── 📁 episode-15-modern-crypto/
│   └── 📁 episode-16-vulnerability/
│
├── 📁 season-5-embedded-arduino/       # Встроенные системы
│   ├── 📄 README.md
│   ├── 📁 episode-17-hardware-intro/
│   ├── 📁 episode-18-sensors-actuators/
│   ├── 📁 episode-19-communication-protocols/
│   └── 📁 episode-20-system-compromise/
│
├── 📁 season-6-lowvoltage-systems/     # Слаботочные системы
│   ├── 📄 README.md
│   ├── 📁 episode-21-access-control/
│   ├── 📁 episode-22-surveillance/
│   ├── 📁 episode-23-fire-alarm/
│   └── 📁 episode-24-ghost-in-system/
│
...
| Season 4 | 13-16 | 12-16 | Алгоритмы, криптография, оптимизация |
| Season 5 | 17-20 | 10-14 | Arduino, embedded, GPIO, I2C/SPI |
| Season 6 | 21-24 | 10-14 | СКУД, видео, Modbus, слаботочка |
...
- S3-S4: Ускорение (networking + algorithms)
- S5-S6: Практика (embedded + real systems)
...
Season 1 (Foundations)
    ↓
    ├──→ Season 2 (Memory) ──→ Season 7 (System Programming)
    │                              ↓
    ├──→ Season 3 (Networks) ─────┤
    │                              ↓
    ├──→ Season 4 (Crypto) ────────┤
