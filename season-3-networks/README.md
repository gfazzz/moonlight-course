...
║  ПЕРИОД:  1-3 октября (Season 2 завершён)               ║
...
**Москва + международные связи! Операция расширяется.**

### 📍 Главные локации:

**🇷🇺 Москва (Episodes 09-12)**
- **Красная площадь:** 55.7558°N, 37.6173°E (IP → GPS)
- **Safe house раскрыт:** 55.7520°N, 37.6175°E (Ep11!)
- **Спасская башня:** Финал — Viktor передаёт USB

**Международные связи:**
- 🇨🇭 **Marcus Weber** звонит из Цюриха (47.3769°N, 8.5417°E)
- 🇳🇱 **DDoS** с IP 185.220.101.47 (Амстердам)

**Команда (6!):** Viktor ЛИЧНО, Ghost→Alex Sokolov (раскрыт!), Marcus, Dmitry, Anna, Крылов
